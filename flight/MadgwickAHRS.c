...
void MadgwickAHRState( float* x, float* y, float* z )
{
	...
	*z = atan2(2 * q1 * q2 - 2 * q0 * q3, 2 * q0*q0 + 2 * q1 * q1 - 1) * 180.0f / 3.14159265359f;
	*y = atan(gx / sqrt(gy*gy + gz*gz)) * 180.0f / 3.14159265359f;
	*x = atan(gy / sqrt(gx*gx + gz*gz)) * 180.0f / 3.14159265359f;
}
