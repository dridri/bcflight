...
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -mfloat-abi=hard -Wl,--unresolved-symbols=ignore-in-shared-libs -I/opt/vc/include/ -I/opt/vc/include/interface/vmcs_host -I/opt/vc/include/interface/vcos/pthreads -I/opt/vc/include/interface/vmcs_host/linux -L/opt/vc/lib/ -Wl,-rpath=/opt/vc/lib")
...
set( BOARD_LIBS -lasound -lwiringPi -lopenmaxil -lbcm_host -lvcos -lvchiq_arm -lvchostif -lrt -lpthread -ldl )
set( BOARD_LIBS ${BOARD_LIBS} -lavformat -lavcodec -lavutil -lz )
