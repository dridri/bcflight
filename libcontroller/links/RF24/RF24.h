...
private:
  ...
  uint16_t spidev; /**< SPI dev select */
  ...
  std::function<void(int,int)> digitalWrite;
  std::function<void(int,int)> pinMode;
...
public:
	...
	void setGPIOFunctions( std::function<void(int,int)> fDigitalWrite, std::function<void(int,int)> fPinMode ) {
		digitalWrite = fDigitalWrite;
		pinMode = fPinMode;
	}
